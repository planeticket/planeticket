(function(){
	...
	$.fn.extend({
	    calendar:function(opt){
	        ...
	        //加载容器
	    	calendarDate.container = '<div class="ht-rili-querybox">'+ opt.title +'<div class="ht-rili-datebox"><span class="ht-rili-leftarr"></span><span class="ht-rili-date"></span><span class="ht-rili-rightarr"></span></div></div><div class="ht-rili-head"><div class="ht-rili-th">SUN&nbsp;日</div><div class="ht-rili-th">MON&nbsp;一</div><div class="ht-rili-th">TUS&nbsp;二</div><div class="ht-rili-th">WED&nbsp;三</div><div class="ht-rili-th">THU&nbsp;四</div><div class="ht-rili-th">FRI&nbsp;五</div><div class="ht-rili-th">SAT&nbsp;六</div></div><div class="ht-rili-body"><!--<div class="ht-rili-td"><span class="ht-rili-day">1</span><span class="ht-rili-money">&yen;100</span></div>--></div>'
